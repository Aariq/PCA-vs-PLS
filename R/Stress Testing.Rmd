...
- Look at this again later.  For now, use scenarios defined in "Generating Datasets.Rmd" for the main aim of the paper.  But--you might learn somethign from the weird stuff going on in these extreme scenarios.
...
ANOVA for global significance of RDA model, returns p-value.
...
Extracts $Q^2$, $p_{(R^2_Y)}$, and $p_{(Q^2)}$ from pls models.
