...
three_scenarios <- 
  plot_grid(null.cor.p + fix_theme_cor,
            ...
            nrow = 3, ncol = 3, align = "v", axis = "l", labels = glue::glue("({letters[1:9]})"), label_x = 0.05) %>% 
  plot_grid(color.bar, align = "h", axis = "t", rel_widths = c(12,1)) 

three_scenarios %>%
  save_plot(here("figs", "three-scenarios.png"), ., ncol = 3, nrow = 3, base_height = 2.8, base_asp = 1.2)
three_scenarios %>%
  save_plot(here("figs", "three-scenarios.eps"), ., ncol = 3, nrow = 3, base_height = 2.8, base_asp = 1.2)
```
