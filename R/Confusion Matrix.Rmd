...
conf_pca <- function(pca.model) {
  ...
  n = test@descriptionMC[1,1] %>% as.numeric()
  t = qt(0.05, n)
...
test.pca %>% conf_pca() %>% calc_kappa()
test.pls %>% conf_pls() %>% calc_kappa()
```
