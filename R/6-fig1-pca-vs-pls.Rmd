...
plot_grid(null.cor.p + fix_theme_cor,
          ...
          null.pca.p + fix_theme_score + labs(title = NULL),
          control.pca.p + fix_theme_score + labs(title = NULL),
          needle.pca.p + fix_theme_score + labs(title = NULL),
  ...
  plot_grid(top[[2]], rel_widths = c(12,1)) %>% 
