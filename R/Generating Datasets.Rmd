...
4. **Control**
    ...
    - two groups of 10 variables with cov = 0.5
    - the discriminating variables will actually have a higher covariance beceause they covary within groups AND differ between groups in the same direction.
