...
## Fit PCA models
Might consider using safely() instead of possibly() to capture errors and report what kind
```{r}
...
- Many models fail for the null, which makes sense. Report how many fail, filter out failing models, and continue on with the remaining models.
