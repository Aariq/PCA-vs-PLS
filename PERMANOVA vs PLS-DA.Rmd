...
PLS-DA performs better than PERMANOVA when:

- many co-varying variables not related to response variable
- especially when co-variance among discriminating variables is high
```
sim.vcov(p_noise = 10,
  p_signal = 25,
  p_disc = 5,
